...
export default {
  components: { Card, CardHeader, CardBody, Input, TitleText, Button },
  setup() {
    const { product, createProduct, resetProduct, isLoading, v$,calcDiscount, calcUtilities, calcDiscountPercentage, calcUtilitiesPercentage } = useProducts();
